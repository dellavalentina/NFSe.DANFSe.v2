...
{
    public static class IbgeResolver
    {
        private static readonly Dictionary<string, string> IbgeCities = new Dictionary<string, string>
        {
        ...
        public static string GetCityName(string code)
        {
            ...
            return IbgeCities.TryGetValue(code, out var city) ? city : code;
        }
    }
}
